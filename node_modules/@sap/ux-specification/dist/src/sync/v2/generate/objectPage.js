...
function addHeaderActionCallBackV2(entityType, appSchema, actionAnnotation, headerActions, oDataServiceAVT) {
    return (item, index) => {
        if (!item['Determining'] && item.$Type === "com.sap.vocabularies.UI.v1.DataFieldForAction" /* UIAnnotationTypes.DataFieldForAction */) {
            ...
            const actionDefinitionKey = `ObjectPageHeaderAction<${(0, common_2.prepareRef)(actionId)}>`;
...
function addFooterActionCallBackV2(entityType, appSchema, footerActions, convertedIdentification) {
    return (item, index) => {
        if (item['Determining'] && item.$Type === "com.sap.vocabularies.UI.v1.DataFieldForAction" /* UIAnnotationTypes.DataFieldForAction */) {
            const action = (0, StableIdHelper_1.getStableIdPartFromDataField)(item);
            const actionId = action.split('::').splice(1).join('::');
            const description = (0, common_1.getDataFieldDescription)(item, entityType);
            const actionDefinitionKey = (0, common_2.prepareRef)(`${ux_specification_types_1.DefinitionName.ObjectPageFooterAction}<${actionId}>`);
...
function ensureCustomColumnDefinitionExists(appSchema, manifest, entitySetName, entityTypeName, oDataServiceAVT, facet, facetKey, fragments) {
    ...
    (0, utils_1.addTableColumnExtensions)(appSchema, entityType, v2Page, manifest, fragments, customColumnsDefinitionName, customColumnDefinitionName);
    return customColumnsDefinitionName;
}
/**
...
function addHeader(appSchema, entityType, oDataServiceAVT) {
    ...
    //Add header actions
    (0, common_2.addHeaderActions)(appSchema, entityType, oDataServiceAVT, addHeaderActionCallBackV2);
}
/**
...
function generateObjectPageSchemaV2(generateParameters, genericSchema) {
    ...
    if (entityType) {
        ...
        (0, common_2.addFooterActions)(appSchema, generateParameters, ux_specification_types_1.FioriElementsVersion.v2, addFooterActionCallBackV2);
