...
function addField(sectionType, appSchema, field, targetID, key, section, version, withActions = true) {
    ...
    if (!field || !field.$Type) {
        ...
        if (withActions && sectionType === ux_specification_types_2.SectionType.Section) {
            const actionsDefinition = (0, __1.prepareRef)(`${sectionType}${ux_specification_types_2.DefinitionName.Actions}<${targetID}>`);
        ...
        const fieldsDefinition = (0, __1.prepareRef)(`${sectionType}${ux_specification_types_2.DefinitionName.Fields}<${targetID}>`);
