...
function fillCustomSubSectionInConfig(importParameters, schemaSection, configPart, sectionId, factory, parentId) {
    ...
    (0, utils_1.transferSettingsOfObject)(section, importParameters.manifest, importParameters.jsonSchema.definitions[sectionIdRef], importParameters.routingId, [`subSections/${sectionId}`], parentId);
