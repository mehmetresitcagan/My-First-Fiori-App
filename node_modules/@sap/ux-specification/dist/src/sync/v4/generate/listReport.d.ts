 ...
 */
export declare function analyzeViewAnnotation(annotationPath: string, uIAnnotations: object, serviceAVT: ConvertedMetadata, viewKey?: string, visualizationType?: Visualization): {
